...
public extension AZTabBarDelegate {
    func tabBar(_: AZTabBarController, statusBarStyleForIndex _: Int) -> UIStatusBarStyle { return .default }

    func tabBar(_: AZTabBarController, shouldLongClickForIndex _: Int) -> Bool { return true }

    func tabBar(_: AZTabBarController, shouldAnimateButtonInteractionAtIndex _: Int) -> Bool { return true }

    func tabBar(_: AZTabBarController, shouldMoveToTabAtIndex _: Int) -> Bool { return true }

    func tabBar(_: AZTabBarController, systemSoundIdForButtonAtIndex _: Int) -> SystemSoundID? { return nil }

    func tabBar(_: AZTabBarController, didSelectTabAtIndex _: Int) {}

    func tabBar(_: AZTabBarController, didLongClickTabAtIndex _: Int) {}

    func tabBar(_: AZTabBarController, willMoveToTabAtIndex _: Int) {}

    func tabBar(_: AZTabBarController, didMoveToTabAtIndex _: Int) {}
}
