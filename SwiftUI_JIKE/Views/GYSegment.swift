...
struct GYSegment: UIViewRepresentable {
    ...
    func updateUIView(_ segment: ZSegmentedControl, context _: Context) {
        segment.selectedIndex = currentPage
    }

    class Coordinator: NSObject, ZSegmentedControlSelectedProtocol {
        func segmentedControlSelectedIndex(_ index: Int, animated _: Bool, segmentedControl _: ZSegmentedControl) {
